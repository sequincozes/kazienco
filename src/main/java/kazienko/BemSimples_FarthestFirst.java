...
public class BemSimples_FarthestFirst {
...
// Criação do cluster (treino)
        ...
        FarthestFirst farthest = Util.clusterDataFarthest(treino, k);
...
//            }
    ...
    public static void testeComClustering(FarthestFirst farthestFirst, Instances instancias) throws Exception {
